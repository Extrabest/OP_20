...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000000000000000000'); // Your max supply. (500 million tokens)
        const decimals: u8 = 18; // 18.
        const name: string = 'Test'; // XtraBest.
        const symbol: string = 'TEST'; // XBT.
